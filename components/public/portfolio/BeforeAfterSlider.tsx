 ...
 *
 * Refinements:
 * - Minimalist semi-transparent labels with backdrop-blur.
 * - Blurred backdrop effect for non-standard image ratios.
 * - Minimalist slider handle design.
 ***************************************************/
...
export default function BeforeAfterSlider({
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full aspect-video select-none overflow-hidden rounded-[2rem] cursor-col-resize shadow-2xl bg-[#090F1A]"
    ...
    >
      ...
      >
        <div className="w-10 h-10 rounded-full bg-white/90 backdrop-blur-xl shadow-xl border border-white/20 flex items-center justify-center cursor-grab active:cursor-grabbing">
